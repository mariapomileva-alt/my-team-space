...
export const TEAM_PERSONALITIES: TeamPersonalitySpec[] = [
  {
    ...
    cssVars: {
      ...
      "--team-style-icon-bg": "color-mix(in srgb, var(--mts-card, #fff) 96%, var(--mts-accent-soft, #f4f4f5))",
      "--team-style-icon-fg": "color-mix(in srgb, var(--mts-primary) 82%, var(--mts-text))",
  ...
  },
  {
    ...
    cssVars: {
      ...
      "--team-style-icon-bg": "var(--mts-primary)",
      "--team-style-icon-fg": "#ffffff",
      "--team-style-page-veil":
