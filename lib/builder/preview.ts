/** Builder preview column width — matches desktop sticky preview column. */

export const BUILDER_PREVIEW_COLUMN_W = 480;

/** Mobile phone frame */
export const BUILDER_PHONE_W = 300;
export const BUILDER_PHONE_H = 560;
