...
export type TeamAdminNavId = "dashboard" | "build" | "members" | "calendar" | "results" | "settings";

const NAV: { id: TeamAdminNavId; href: (teamId: string) => string; label: string; icon: string }[] = [
