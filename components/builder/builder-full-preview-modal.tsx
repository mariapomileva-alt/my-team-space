      ...
      {open ? (
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 flex max-h-[92vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl border border-zinc-200/90 bg-white shadow-2xl"
          >
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-zinc-100 px-4 py-3 sm:px-5">
              <div>
                <p className="text-sm font-bold text-zinc-900">Full preview</p>
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 border-t border-zinc-100 px-4 py-3 sm:px-5">
              <p className="text-[11px] text-zinc-500">
                {mode === "mobile" ? `Phone frame · ${BUILDER_PHONE_W}×${BUILDER_PHONE_H}` : "Desktop width preview"}
              </p>
              <button
                type="button"
                onClick={() => {
