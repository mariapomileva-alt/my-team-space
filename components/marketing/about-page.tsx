...
export function AboutPage() {
  return (
    <section className="mx-auto max-w-3xl px-6 pb-14 pt-10 sm:px-8 sm:pb-16 sm:pt-12">
      <h1 className="text-center font-[family-name:var(--font-brand)] text-3xl font-bold tracking-tight text-[#1A1C23] sm:text-4xl">
      ...
      <div className="mt-10 rounded-3xl border border-black/[0.06] bg-white p-8 text-center shadow-sm">
